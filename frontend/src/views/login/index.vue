  ...
  <div class="login-signup">
    <div class="container">
      ...
      <div class="switch-btn-page" ref="btnPage">
        <el-button type="primary" size="large" class="switch-2-signup login-btn" :disabled="loginStore.btnsDisabled"
          :loading="loginStore.btnsDisabled" @click="dialogVisible = true">
          Sign up 注册
        </el-button>
        <el-button type="primary" size="large" class="switch-2-login login-btn" :disabled="loginStore.btnsDisabled"
          :loading="loginStore.btnsDisabled" @click="dialogVisible = true">
          Log in 登录
        </el-button>
      </div>
...
.login-signup {
  width: 100%;
  height: clamp(var(--min-viewport-height), 100%, 100%);
  background: url('@/assets/images/login_background.jpg') center/100% 100% no-repeat;
  display: flex;

<template>
  <el-card class="essay-item" body-class="essay-item-body" ref="essayItemRef" :body-style="{
    ...
    <div style="height: 100%">
      ...
      <p class="essay-content-text" ref="essayContentTextRef">
        <slot name="content"></slot>
      </p>
      <div class="essay-content-media">
...
const essayContentTextRef = ref<HTMLElement>() // 文章内容
...
const textOverflowStyle = () => {
  const essayContent = essayContentTextRef.value
